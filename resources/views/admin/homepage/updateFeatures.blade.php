...
@section('admintitle') Feature Update @endsection
@section('maincontent')
...
<div class="col-xl-6 box-margin">
    <div class="card">
        <div class="card-body">
            ...
            <form class="cmxform"  method="post" enctype="multipart/form-data" action="{{route('home.featurePost',$feature->id)}}">
                @csrf
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <a href=""><img src="{{asset('website/homepage/'.$feature->icon)}}" alt="" style="width:80px;height:80px;"></a>
                      <br>  <span class="text-danger">(NOTE-PNG,JPG,JPEG,Size-512KB,Min_Dim-100X100,Max_Dim-300X300)</span>
