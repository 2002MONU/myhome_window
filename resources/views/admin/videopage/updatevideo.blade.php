...
@section('admintitle') Video @endsection
@section('maincontent')
...
<div class="col-xl-6 box-margin">
    <div class="card">
        <div class="card-body">
            ...
            <form class="cmxform"  method="post" enctype="multipart/form-data" action="{{route('video-videoPost',$video->id)}}">
                @csrf
                <fieldset>
                    <div class="form-group">
                        <label for="image">Video Link</label>
                        <input type="text"  class="form-control" name="link" value="{{$video->link}}" placeholder="https://www.youtube.com/embed/vN_7VqXe_0U?si=OL63Xup7K_JB6vGK" >
                        @if ($errors->has('link'))
